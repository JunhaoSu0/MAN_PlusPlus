...
parser = argparse.ArgumentParser(description='MAN++ DGL training on CIFAR/SVHN/STL')
...
parser.add_argument('--arch', default='resnetDGL_MANPP', type=str, choices=sorted(ARCH_ALIASES),
                    help='network module name; resnetDGL_MAN is accepted for compatibility')
