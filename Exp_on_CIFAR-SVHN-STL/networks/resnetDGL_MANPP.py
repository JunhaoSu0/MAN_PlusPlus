...
class MANPPDGLResNet(nn.Module):
    ...
    def __init__(self, block, layers, arch, local_module_num, batch_size, image_size=32,
        ...
        super(MANPPDGLResNet, self).__init__()
...
def resnet32(**kwargs):
    model = MANPPDGLResNet(BasicBlock, [5, 5, 5], arch='resnet32', **kwargs)
    return model
...
def resnet110(**kwargs):
    model = MANPPDGLResNet(BasicBlock, [18, 18, 18], arch='resnet110', **kwargs)
    return model
